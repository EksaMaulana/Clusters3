...
<head>
    ...
    <title>Toko Printer Alluka</title>
...
<body>
    ...
    justify-content-between">
            <div class="logo">
                <h1><a href="index.html">Toko Mwhehehe</a> </h1> <!-- Uncomment below if
    you prefer to use an image logo -->
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    @if(!Auth::check())
                    <li><a class="getstarted scrollto" href="/masuk">Login</a></li>
                    @else
            ...
            <div class="row">
                <div class="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    ...
                    <div data-aos="fade-up" data-aos-delay="800">
                        <a href="/masuk" class="btn-get-started scrollto">Ayo Gabung</a>
                    </div>
                </div>
